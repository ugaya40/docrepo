  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`relative p-2.5 rounded-lg transition-colors focus:outline-none ${isLight
...
const ThemeOption: React.FC<ThemeOptionProps> = ({ label, icon, isActive, onClick, isLight }) => {
  return (
    <button
      onClick={onClick}
      className={`w-full px-4 py-3 text-sm flex items-center gap-3 transition-colors ${isLight
